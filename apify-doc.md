{
  "openapi": "3.0.1",
  "info": {
    "title": "Linkedin Post Scraper ✅ No cookies ✅ $2 per 1k posts",
    "description": "Scrape unlimited Linkedin posts without risking your Linkedin account. Live data, Super fast scraping at affordable cost. High success rate",
    "version": "1.0",
    "x-build-id": "hne3q4iGkD9CdGFjp"
  },
  "servers": [
    {
  ...
  "paths": {
    "/acts/supreme_coder~linkedin-post/run-sync-get-dataset-items": {
      "post": {
        "operationId": "run-sync-get-dataset-items-supreme_coder-linkedin-post",
    ...
    "/acts/supreme_coder~linkedin-post/runs": {
      "post": {
        "operationId": "runs-sync-supreme_coder-linkedin-post",
        "x-openai-isConsequential": false,
    ...
    "/acts/supreme_coder~linkedin-post/run-sync": {
      "post": {
        "operationId": "run-sync-supreme_coder-linkedin-post",
        "x-openai-isConsequential": false,
